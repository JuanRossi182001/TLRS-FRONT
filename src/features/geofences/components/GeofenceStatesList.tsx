...
const geofenceStatesPageLimit = 3;
      ...
      <div className="grid items-center gap-3 xl:grid-cols-[3rem_1fr_3rem]">
        ...
        >
          ...
          <div className="relative overflow-hidden rounded-3xl">
            <div
              className={[
                'grid gap-3 transition duration-400 ease-out sm:grid-cols-2 xl:grid-cols-3 xl:gap-2',
                pageTransitionClass,
              ].join(' ')}
            >
              {sortedStates.map((state) => {
                ...
                return (
                  <Card
                    className="space-y-3 p-4 transition hover:-translate-y-0.5 hover:shadow-md hover:shadow-brand-primary/10 xl:space-y-2 xl:p-3"
